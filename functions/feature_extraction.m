...
feature(10) = entropy_ex(cd1);
feature(11) = entropy_ex(cd2);
feature(12) = entropy_ex(cd3);
feature(13) = entropy_ex(cd4);
feature(14) = entropy_ex(cd5);
feature(15) = entropy_ex(cd6);
feature(16) = entropy_ex(cd7);
feature(17) = entropy_ex(cd8);
feature(18) = entropy_ex(ca1);
...
feature(43) = kurtosis_ex(cd7);
feature(44) = kurtosis_ex(cd8);
